...
router.post('/addNewCategory',blogControllers.checkAuth,blogControllers.newCategory)
router.get('/editCategory/:id',blogControllers.checkAuth,blogControllers.editCategory_get);
router.put('/editCategory/:id',blogControllers.checkAuth,blogControllers.editCategory_put);
router.delete('/deleteCategory/:id',blogControllers.checkAuth,blogControllers.deleteCategory);
router.get('/signup',blogControllers.checkAuth,blogControllers.getSignup);
router.post('/signup',blogControllers.checkAuth,blogControllers.postSignup);
